              ...
              <div className="flex justify-between items-start">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className={`p-2.5 lg:p-3 rounded-full transition-colors active-scale ${isFavorited
                        ? 'bg-playful-cream border border-playful-coral/20 text-playful-coral'
                        : 'bg-gray-50 lg:bg-playful-cream text-gray-400 hover:bg-red-50 hover:text-red-500'
                      }`}
                  >
                    <Heart className={`w-5 h-5 lg:w-6 lg:h-6 ${isFavorited ? 'fill-current' : ''}`} />
                  </button>
                  <ShareButton pet={pet} />
                </div>
              </div>
