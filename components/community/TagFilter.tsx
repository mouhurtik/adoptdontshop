...
const TagFilter = ({ activeTag, onTagChange }: TagFilterProps) => {
    ...
    // Controls CSS mount/unmount animation for the mobile modal
    ...
    return (
        <div className={`relative ${isOpen ? 'z-[100]' : 'z-30'}`}>
            ...
            <div className="md:hidden">
                ...
                {isOpen && (
                    <div 
                        className={`fixed inset-0 z-[100] flex items-center justify-center p-4 transition-all duration-250 ease-out ${
                            showModal ? 'bg-black/50 backdrop-blur-sm' : 'bg-black/0'
                        }`}
                        onClick={handleCloseModal}
                    >
                        <div
                            className={`bg-white rounded-[2rem] p-6 shadow-xl w-full max-w-md border-2 border-playful-cream relative transition-all duration-250 ease-out ${
                                showModal
                            ...
                            <div className="flex flex-col gap-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <div
                                            className={`absolute top-full mt-2 left-0 right-0 z-50 bg-white border border-gray-100 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.1)] rounded-[1.5rem] p-2 max-h-[40vh] overflow-y-auto hide-scrollbar transition-all duration-150 ease-out origin-top ${
                                                isDropdownOpen
