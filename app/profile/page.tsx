...
import { User, Mail, MapPin, Phone, Building2, Edit, ListChecks, PawPrint } from 'lucide-react';
        ...
        <ScrollReveal mode="fade-up" delay={0.2} width="100%">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-8">
            <div className="bg-white rounded-[2rem] p-6 shadow-soft border-2 border-playful-yellow/30 text-center hover:scale-105 transition-transform duration-300">
              <div className="bg-playful-yellow/20 p-4 w-16 h-16 mx-auto mb-3 flex items-center justify-center rounded-full">
                <PawPrint className="h-8 w-8 text-yellow-600" />
              </div>
              <p className="text-4xl font-black text-playful-text">{petCount}</p>
              <p className="text-gray-600 font-bold">Pets Listed</p>
            </div>
            ...
            <div className="bg-white rounded-[2rem] p-6 shadow-soft border-2 border-playful-teal/30 text-center hover:scale-105 transition-transform duration-300">
              <div className="bg-playful-teal/20 p-4 w-16 h-16 mx-auto mb-3 flex items-center justify-center rounded-full">
                <Edit className="h-8 w-8 text-playful-teal" />
              </div>
              <p className="text-4xl font-black text-playful-text">{appCount}</p>
              <p className="text-gray-600 font-bold">Applications Received</p>
            </div>
          </div>
        </ScrollReveal>
