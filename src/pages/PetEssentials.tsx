...
const PetEssentials = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            {/* Insurance Section */}
            <section className="py-20 bg-playful-text text-white relative overflow-hidden">
                <div className="absolute top-0 right-0 w-1/3 h-full bg-playful-coral/10 blur-3xl rounded-full translate-x-1/2" />
                <div className="absolute bottom-0 left-0 w-1/3 h-full bg-playful-yellow/10 blur-3xl rounded-full -translate-x-1/2" />

                <div className="container mx-auto px-4 relative z-10">
                    <div className="grid md:grid-cols-2 gap-12 items-center">
                        <div>
                            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 text-playful-yellow font-bold text-sm mb-6 border border-white/20">
                                <Shield className="w-4 h-4" />
                                Peace of Mind Protected
                            </div>
                            <h2 className="text-4xl md:text-5xl font-black mb-6 leading-tight">
                                Protect Your Pet With Top-Rated Insurance
                            </h2>
                            ...
                            <ul className="space-y-4 mb-8">
                                {[
                                    ...
                                    <li key={i} className="flex items-center gap-3 text-gray-200">
                                        <div className="w-6 h-6 rounded-full bg-playful-coral flex items-center justify-center shrink-0">
                            ...
                            <PrimaryButton variant="secondary" size="lg" className="bg-playful-yellow text-playful-text hover:bg-white border-none">
                                Get a Free Quote
                            </PrimaryButton>
                        </div>
                        ...
                        <div className="relative">
                            ...
                            >
                                <Card className="bg-white/5 border-white/10 backdrop-blur-sm p-2 text-white overflow-hidden">
                                    <img
                                    ...
                                    <div className="p-6">
                                        <div className="flex justify-between items-center mb-2">
                                            ...
                                            <span className="text-2xl font-black text-playful-yellow">$25<span className="text-sm text-gray-400 font-normal">/mo</span></span>
                                        </div>
                                        <p className="text-gray-400 text-sm">Great for puppies and young pets.</p>
                                    </div>
                                </Card>
                            </motion.div>

                            {/* Decorative Elements */}
                            <div className="absolute -top-6 -right-6 w-24 h-24 bg-playful-coral rounded-full opacity-20 blur-xl" />
                            <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-playful-yellow rounded-full opacity-20 blur-xl" />
                        </div>
                    </div>
                </div>
            </section>
